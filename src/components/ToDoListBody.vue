    ...
    <ul class="todo-list">
      <li :class="{'completed':todo.completed, 'editing': todo.edit === true}" v-for="(todo, index) in todoItems" :key="index">
        <div class="view" v-show="todo.edit == false">
          ...
          <input class="edit" placeholder="edit name" autofocus v-model="newName" @keyup.enter="updateItem(todo), todo.edit = false" @keyup.esc="todo.edit = false, autofocus" tabindex="-1"> 
      </li>
    </ul>
  </section>
</template>
